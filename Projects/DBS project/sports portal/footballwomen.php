	...
	<div class="container gap">
		...
		<div class="col-sm-10 row">
			<ol class="breadcrumb">
			    ...
			    <li class="active">Football-Women</li>
			</ol>
			<div class="col-sm-4 col-sm-push-1"><!-- for number of people -->
				<div class="row row-content">
					...
					<form action="footballwomen.php" method="POST">
				...
				<div class="gap">
					<form action="FBwomen.php" method="POST">
						<?php
							//session_start();
							$players = $_POST['players'];
							/*$_SESSION['players']=$players;
							find a way to keep track of number of people and names for input fields.
							use sessions probably .... */
							$delegatewomen = array();
							if($players>15)
								echo "Maximum 15 players!";
							else{
							?>
							...
							for ($i=0; $i <$players ; $i++) { 
								...
								?>
								<label><?php echo ($i+1).'.';?></label><input class="form-group left-pad" type="text" name="delegatewomen[]" required><br>
								<?php
								if ($i==($players-1)) {
									?>
								<button class="btn btn-primary" value="submit">Next</button>
			...
			<div class="col-sm-3 col-sm-push-4"><!-- for teamID -->
				<form action="usingIDFBW.php" method="POST">
