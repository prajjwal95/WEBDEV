	...
	<div class="container gap"> 
		...
		<div class="col-sm-10 row">
			<ol class="breadcrumb">
			    ...
			    <li class="active">Football-Men</li>
			  </ol>
			<div class="col-sm-4 col-sm-push-1"><!-- for number of people -->
				<div class="row row-content">
					...
					<form action="footballmen.php" method="POST">
				...
				<div class="gap">
					<form action="FBmen.php" method="POST">
					<?php
						$players = $_POST['players'];
						$delegatemen = array();
						if($players>11)
							echo "Maximum 11 players!";
						else{
						?>
						...
						for ($i=0; $i <$players ; $i++) { 
							...
							<label><?php echo ($i+1).'.';?></label><input class="form-group left-pad" type="text" name="delegatemen[]" required><br>
							<?php
							if ($i==($players-1)) {
								?>
							<button class="btn btn-primary" value="submit">Next</button>
			...
			<div class="col-sm-3 col-sm-push-4"><!-- for teamID -->
				<form action="usingIDFBM.php" method="POST">
