		...
		<div class="col-sm-10 row">
			...
			<div class="col-sm-4 col-sm-push-1"><!-- for number of people -->
				<div class="row row-content">
					...
					<form action="basketballwomen.php" method="POST">
				...
				<div class="gap">
					<form action="BBRegWomen.php" method="POST"> 
							<?php
							$players = $_POST['players'];
							$delegatewomen = array();
							if($players>6)
								echo "Maximum 6 players!";
							else{
							?>
							<?php
							for ($i=0; $i <$players ; $i++) {
								...
								?>
								<label><?php echo ($i+1).'.'; ?></label><input class="form-group left-pad" type="text" name="delegatewomen[]"><br>
								<?php
								if ($i==($players-1)) {
									?>
								<button class="btn btn-primary" value="submit">Next</button>
			...
			<div class="col-sm-3 col-sm-push-4">
				<form action="usingIDBBallWomen.php" method="POST">
